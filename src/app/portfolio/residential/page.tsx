...
export default function ResidentialPage() {
  ...
  const prevSlide = () => {
    setCurrentIndex(
      (prev) => (prev - 1 + residentialProjects.length) % residentialProjects.length
    );
  };
    ...
    <div className="bg-black text-white min-h-screen">
      ...
      <div className="container mx-auto px-6 py-12 text-center">
        ...
        <p className="max-w-3xl mx-auto text-lg mb-6">
          Transform your home into a masterpiece with our expert residential interior design services.
        </p>
